...
SCHEMA_PATH = Path('C:/Users/RaviA/Desktop/HACKERZ/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\RaviA\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    challenge: 'actions.ChallengeActions[models.Challenge]'
    solve: 'actions.SolveActions[models.Solve]'
    ...
    def __init__(
        ...
        *,
        ...
        self.challenge = actions.ChallengeActions[models.Challenge](self, models.Challenge)
        self.solve = actions.SolveActions[models.Solve](self, models.Solve)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/RaviA/Desktop/HACKERZ/schema.prisma',
        }
...
class Batch:
    ...
    challenge: 'ChallengeBatchActions'
    solve: 'SolveBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.challenge = ChallengeBatchActions(self)
        self.solve = SolveBatchActions(self)
